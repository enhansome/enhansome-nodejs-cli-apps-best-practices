...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,382 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
* [yargs](https://github.com/yargs/yargs) ⭐ 11,512 | 🐛 211 | 🌐 JavaScript | 📅 2026-08-31
...
* [cosmiconfig](https://github.com/davidtheclark/cosmiconfig) ⭐ 4,159 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,512 | 🐛 211 | 🌐 JavaScript | 📅 2026-08-31
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 731 \| 🐛 21 \| 🌐 TypeScript \| 📅 2026-09-01                                |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,783 \| 🐛 172 \| 🌐 Go \| 📅 2026-09-01 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,783 \| 🐛 172 \| 🌐 Go \| 📅 2026-09-01            | Create repeatable CLI demos for READMEs, docs, and release notes. |
