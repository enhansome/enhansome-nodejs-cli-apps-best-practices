...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,399 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-14
* [yargs](https://github.com/yargs/yargs) ⭐ 11,504 | 🐛 214 | 🌐 JavaScript | 📅 2026-09-18
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,504 | 🐛 214 | 🌐 JavaScript | 📅 2026-09-18
* [tabtab](https://github.com/mklabs/tabtab) ⭐ 377 | 🐛 43 | 🌐 JavaScript | 📅 2023-01-04
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,937 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,937 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
...
| tabtab                     | Completion helpers for Node.js CLI programs.                                        | [Link to npm](https://www.npmjs.com/package/tabtab)                                                                 | [Link to GitHub](https://github.com/mklabs/tabtab) ⭐ 377 \| 🐛 43 \| 🌐 JavaScript \| 📅 2023-01-04            | Build custom Bash, Zsh, and Fish completion flows.                |
