...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,401 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-14
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,505 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14
...
| prompts           | Lightweight, beautiful and user-friendly interactive prompts                                                              | [Link to npm](https://npmjs.org/package/prompts)               | [Link to GitHub](https://github.com/terkelg/prompts) ⭐ 9,312 \| 🐛 152 \| 🌐 JavaScript \| 📅 2025-05-14                            | ![](https://img.shields.io/github/stars/terkelg/prompts)![](https://img.shields.io/npm/dt/prompts.svg)                 |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,933 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,933 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
