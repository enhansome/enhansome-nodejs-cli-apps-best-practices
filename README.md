...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,406 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-21
* [yargs](https://github.com/yargs/yargs) ⭐ 11,504 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-21
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,511 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14
...
* [cosmiconfig](https://github.com/davidtheclark/cosmiconfig) ⭐ 4,166 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,504 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-21
* [tabtab](https://github.com/mklabs/tabtab) ⭐ 376 | 🐛 43 | 🌐 JavaScript | 📅 2023-01-04
* [@oclif/plugin-autocomplete](https://github.com/oclif/plugin-autocomplete) ⭐ 95 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-22
...
| blessed           | A curses-like library with a high level terminal interface API for node.js.                                               | [Link to npm](https://www.npmjs.com/package/blessed)           | [Link to GitHub](https://github.com/chjj/blessed) ⭐ 11,886 \| 🐛 255 \| 🌐 JavaScript \| 📅 2024-03-22                              | ![](https://img.shields.io/github/stars/chjj/blessed)![](https://img.shields.io/npm/dt/blessed.svg)                    |
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 737 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-09-15                                 |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,965 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,965 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
| @oclif/plugin-autocomplete | An oclif plugin for generating shell autocomplete support.                          | [Link to npm](https://www.npmjs.com/package/@oclif/plugin-autocomplete)                                             | [Link to GitHub](https://github.com/oclif/plugin-autocomplete) ⭐ 95 \| 🐛 16 \| 🌐 TypeScript \| 📅 2026-09-22 | Add completion support to oclif-based CLIs.                       |
| tabtab                     | Completion helpers for Node.js CLI programs.                                        | [Link to npm](https://www.npmjs.com/package/tabtab)                                                                 | [Link to GitHub](https://github.com/mklabs/tabtab) ⭐ 376 \| 🐛 43 \| 🌐 JavaScript \| 📅 2023-01-04            | Build custom Bash, Zsh, and Fish completion flows.                |
