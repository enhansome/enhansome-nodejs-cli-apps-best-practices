...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,386 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,502 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-29
...
* [cosmiconfig](https://github.com/davidtheclark/cosmiconfig) ⭐ 4,162 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 732 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-09-04                                |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,806 \| 🐛 173 \| 🌐 Go \| 📅 2026-09-01 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,806 \| 🐛 173 \| 🌐 Go \| 📅 2026-09-01            | Create repeatable CLI demos for READMEs, docs, and release notes. |
