...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,365 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-17
...
* [cosmiconfig](https://github.com/davidtheclark/cosmiconfig) ⭐ 4,160 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-02
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| oclif             | A framework for building a command line interface.                                                                        | [Link to npm](https://www.npmjs.com/package/oclif)             | [Link to GitHub](https://github.com/oclif/oclif) ⭐ 9,577 \| 🐛 22 \| 🌐 TypeScript \| 📅 2026-08-10                                 | ![](https://img.shields.io/github/stars/oclif/oclif)![](https://img.shields.io/npm/dt/oclif.svg)                       |
...
| ink UI            | Collection of customizable UI components for CLIs made with Ink.                                                          | [Link to npm](https://www.npmjs.com/package/@inkjs/ui)         | [Link to Github](https://github.com/vadimdemedes/ink-ui) ⭐ 2,053 \| 🐛 21 \| 🌐 TypeScript \| 📅 2024-05-22                         | ![](https://img.shields.io/github/stars/vadimdemedes/ink-ui)![](https://img.shields.io/npm/dt/@inkjs/ui.svg)           |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,663 \| 🐛 168 \| 🌐 Go \| 📅 2026-08-12 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,663 \| 🐛 168 \| 🌐 Go \| 📅 2026-08-12            | Create repeatable CLI demos for READMEs, docs, and release notes. |
