...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,387 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
* [yargs](https://github.com/yargs/yargs) ⭐ 11,511 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,511 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04
...
| ink UI            | Collection of customizable UI components for CLIs made with Ink.                                                          | [Link to npm](https://www.npmjs.com/package/@inkjs/ui)         | [Link to Github](https://github.com/vadimdemedes/ink-ui) ⭐ 2,067 \| 🐛 21 \| 🌐 TypeScript \| 📅 2024-05-22                         | ![](https://img.shields.io/github/stars/vadimdemedes/ink-ui)![](https://img.shields.io/npm/dt/@inkjs/ui.svg)           |
| blessed           | A curses-like library with a high level terminal interface API for node.js.                                               | [Link to npm](https://www.npmjs.com/package/blessed)           | [Link to GitHub](https://github.com/chjj/blessed) ⭐ 11,887 \| 🐛 256 \| 🌐 JavaScript \| 📅 2024-03-22                              | ![](https://img.shields.io/github/stars/chjj/blessed)![](https://img.shields.io/npm/dt/blessed.svg)                    |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,831 \| 🐛 174 \| 🌐 Go \| 📅 2026-09-01 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,831 \| 🐛 174 \| 🌐 Go \| 📅 2026-09-01            | Create repeatable CLI demos for READMEs, docs, and release notes. |
