...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,382 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-31
* [yargs](https://github.com/yargs/yargs) ⭐ 11,513 | 🐛 210 | 🌐 JavaScript | 📅 2026-08-31
...
* [cosmiconfig](https://github.com/davidtheclark/cosmiconfig) ⭐ 4,159 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-30
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,513 | 🐛 210 | 🌐 JavaScript | 📅 2026-08-31
* [tabtab](https://github.com/mklabs/tabtab) ⭐ 378 | 🐛 43 | 🌐 JavaScript | 📅 2023-01-04
* [@oclif/plugin-autocomplete](https://github.com/oclif/plugin-autocomplete) ⭐ 95 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-31
...
If the CLI is invoked in an unsupported environment, attempt to detect it and exit with a descriptive error message to present a friendly and information error message. See [this example](https://github.com/lirantal/dockly/blob/42d8c09631bc5348f108a50c3ce9601851fb760b/index.js#L25) ⭐ 4,033 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-23 for dockly.
...
| ink UI            | Collection of customizable UI components for CLIs made with Ink.                                                          | [Link to npm](https://www.npmjs.com/package/@inkjs/ui)         | [Link to Github](https://github.com/vadimdemedes/ink-ui) ⭐ 2,060 \| 🐛 21 \| 🌐 TypeScript \| 📅 2024-05-22                         | ![](https://img.shields.io/github/stars/vadimdemedes/ink-ui)![](https://img.shields.io/npm/dt/@inkjs/ui.svg)           |
...
| prompts           | Lightweight, beautiful and user-friendly interactive prompts                                                              | [Link to npm](https://npmjs.org/package/prompts)               | [Link to GitHub](https://github.com/terkelg/prompts) ⭐ 9,308 \| 🐛 150 \| 🌐 JavaScript \| 📅 2025-05-14                            | ![](https://img.shields.io/github/stars/terkelg/prompts)![](https://img.shields.io/npm/dt/prompts.svg)                 |
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 731 \| 🐛 23 \| 🌐 TypeScript \| 📅 2026-08-31                                |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,776 \| 🐛 171 \| 🌐 Go \| 📅 2026-08-24 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,776 \| 🐛 171 \| 🌐 Go \| 📅 2026-08-24            | Create repeatable CLI demos for READMEs, docs, and release notes. |
| @oclif/plugin-autocomplete | An oclif plugin for generating shell autocomplete support.                          | [Link to npm](https://www.npmjs.com/package/@oclif/plugin-autocomplete)                                             | [Link to GitHub](https://github.com/oclif/plugin-autocomplete) ⭐ 95 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-08-31 | Add completion support to oclif-based CLIs.                       |
...
This project follows the [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,096 | 🐛 90 | 🌐 MDX | 📅 2026-08-27 specification. Contributions of any kind welcome!
