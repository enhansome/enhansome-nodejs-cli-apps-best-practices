...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,361 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-11
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,494 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-21
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,621 \| 🐛 169 \| 🌐 Go \| 📅 2026-08-12 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,621 \| 🐛 169 \| 🌐 Go \| 📅 2026-08-12            | Create repeatable CLI demos for READMEs, docs, and release notes. |
