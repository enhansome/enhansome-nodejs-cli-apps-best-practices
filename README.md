...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,403 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-21
* [yargs](https://github.com/yargs/yargs) ⭐ 11,505 | 🐛 210 | 🌐 JavaScript | 📅 2026-09-20
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,510 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,505 | 🐛 210 | 🌐 JavaScript | 📅 2026-09-20
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,947 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,947 \| 🐛 176 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
