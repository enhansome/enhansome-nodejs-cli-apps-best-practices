...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,507 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,507 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| oclif             | A framework for building a command line interface.                                                                        | [Link to npm](https://www.npmjs.com/package/oclif)             | [Link to GitHub](https://github.com/oclif/oclif) ⭐ 9,590 \| 🐛 23 \| 🌐 TypeScript \| 📅 2026-09-03                                 | ![](https://img.shields.io/github/stars/oclif/oclif)![](https://img.shields.io/npm/dt/oclif.svg)                       |
| yargs             | A command line parser for complex CLIs with commands, options, generated help, and shell completion support.              | [Link to npm](https://www.npmjs.com/package/yargs)             | [Link to GitHub](https://github.com/yargs/yargs) ⭐ 11,507 \| 🐛 211 \| 🌐 JavaScript \| 📅 2026-09-04                               | ![](https://img.shields.io/github/stars/yargs/yargs)![](https://img.shields.io/npm/dt/yargs.svg)                       |
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 733 \| 🐛 11 \| 🌐 TypeScript \| 📅 2026-09-10                                |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,851 \| 🐛 173 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,851 \| 🐛 173 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
