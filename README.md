...
* [yargs](https://github.com/yargs/yargs) ⭐ 11,515 | 🐛 219 | 🌐 JavaScript | 📅 2026-08-07
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,515 | 🐛 219 | 🌐 JavaScript | 📅 2026-08-07
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,704 \| 🐛 170 \| 🌐 Go \| 📅 2026-08-24 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,704 \| 🐛 170 \| 🌐 Go \| 📅 2026-08-24            | Create repeatable CLI demos for READMEs, docs, and release notes. |
