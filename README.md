...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,381 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-24
* [yargs](https://github.com/yargs/yargs) ⭐ 11,513 | 🐛 208 | 🌐 JavaScript | 📅 2026-08-07
...
* [yargs `.completion()`](https://github.com/yargs/yargs/blob/main/docs/api.md#completioncmd-description-fn) ⭐ 11,513 | 🐛 208 | 🌐 JavaScript | 📅 2026-08-07
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| oclif             | A framework for building a command line interface.                                                                        | [Link to npm](https://www.npmjs.com/package/oclif)             | [Link to GitHub](https://github.com/oclif/oclif) ⭐ 9,585 \| 🐛 21 \| 🌐 TypeScript \| 📅 2026-08-29                                 | ![](https://img.shields.io/github/stars/oclif/oclif)![](https://img.shields.io/npm/dt/oclif.svg)                       |
| yargs             | A command line parser for complex CLIs with commands, options, generated help, and shell completion support.              | [Link to npm](https://www.npmjs.com/package/yargs)             | [Link to GitHub](https://github.com/yargs/yargs) ⭐ 11,513 \| 🐛 208 \| 🌐 JavaScript \| 📅 2026-08-07                               | ![](https://img.shields.io/github/stars/yargs/yargs)![](https://img.shields.io/npm/dt/yargs.svg)                       |
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 730 \| 🐛 24 \| 🌐 TypeScript \| 📅 2026-08-30                                |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,772 \| 🐛 171 \| 🌐 Go \| 📅 2026-08-24 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,772 \| 🐛 171 \| 🌐 Go \| 📅 2026-08-24            | Create repeatable CLI demos for READMEs, docs, and release notes. |
...
This project follows the [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,095 | 🐛 90 | 🌐 MDX | 📅 2026-08-27 specification. Contributions of any kind welcome!
