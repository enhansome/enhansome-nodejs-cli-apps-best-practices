...
* [commander](https://github.com/tj/commander.js#readme) ⭐ 28,389 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
...
* [open](https://github.com/sindresorhus/open) ⭐ 3,502 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-11
...
| Optique           | Type-safe combinatorial CLI parser for TypeScript                                                                         | [Link to npm](https://www.npmjs.com/package/@optique/core)     | [Link to GitHub](https://github.com/dahlia/optique) ⭐ 734 \| 🐛 9 \| 🌐 TypeScript \| 📅 2026-09-11                                 |                                                                                                                        |
...
| -------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| VHS                        | A tool for scripting, recording, and rendering terminal sessions as GIFs or videos. | [Installation docs](https://github.com/charmbracelet/vhs#installation) ⭐ 20,876 \| 🐛 174 \| 🌐 Go \| 📅 2026-09-09 | [Link to GitHub](https://github.com/charmbracelet/vhs) ⭐ 20,876 \| 🐛 174 \| 🌐 Go \| 📅 2026-09-09            | Create repeatable CLI demos for READMEs, docs, and release notes. |
